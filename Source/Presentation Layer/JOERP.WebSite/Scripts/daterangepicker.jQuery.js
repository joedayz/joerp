...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'Del Mes a la Fecha', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: 'Del Anho a la fecha', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
		...
		presets: {
			...
			allDatesBefore: 'Todas las fechas despues', 
			allDatesAfter: 'Todas las fechas anteriores', 
